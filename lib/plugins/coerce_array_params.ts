 ...
 * types the field as an array — `resource`, the one parameter RFC 8707 lets a client repeat. This
 * normalizes each such value to a
 ...
 *
 *   new Elysia().use(coerceArrayParams('resource')).post(...)
 */
