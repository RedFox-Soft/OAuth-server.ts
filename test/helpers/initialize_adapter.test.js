...
describe('initializeAdapter helper', () => {
	...
	it('should be success if argument is arrow function', () => {
		expect(initializeAdapter.bind(undefined, () => {}).method).to.be.not.throw;
	});
});
