...
| -------------------- | --------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------- |
| A **signature**      | `cosign sign`, keyless, over the image digest                         | These exact bytes were pushed by this repository's release workflow, running on a version tag, and not by anyone holding a token |
...
[`Dockerfile`](https://github.com/RedFox-Soft/OAuth-server.ts/blob/main/Dockerfile) chooses to run
...
- **No OpenID Foundation certification.** The suite has been run, and
  [`CONFORMANCE.md`](https://github.com/RedFox-Soft/OAuth-server.ts/blob/main/CONFORMANCE.md)
