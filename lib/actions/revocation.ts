...
// Before AuthPlugin: it throws invalid_client from a `derive` in the transform queue, so a hook
// registered after it never runs on that 401.
export const revocation = new Elysia()
